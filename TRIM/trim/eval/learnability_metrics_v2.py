...
from trim.training.canonical_metrics import NUMERIC_FLOOR, aggregate_token_metrics
from trim.training.hf_tool_opd import ScapeHFToolOPD, LossPath
from trim.training.tool_mask import legal_tool_names, tool_loss_mask_from_response
from trim.training.tool_opd import disagreement_stats, normalize_probs
...
def _tool_name_js_from_logits(
  ...
  from trim.training.canonical_metrics import js_from_logits
...
def score_row_v2(
  ...
  *,
  ...
  import torch
  from trim.training.canonical_metrics import (
    js_from_logits,
    kl_from_logits,
    signed_logprob_gap,
  )
...
def masked_mean_js(
  ...
  from trim.training.canonical_metrics import js_from_logits, masked_mean
...
def tool_name_distribution_js(
  ...
  from trim.training.tool_opd import js_divergence
