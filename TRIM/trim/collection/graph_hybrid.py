...
from trim.rendering.dual_view import DualViewRenderer, default_render
from trim.state.snapshot import EnvironmentSnapshot, stable_hash
...
def build_graph_hybrid_row(
  *,
  ...
  from trim.eval.learnability_metrics_v2 import tool_name_distribution_js
  from trim.training.tool_opd import normalize_probs
