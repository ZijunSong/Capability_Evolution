...
try:
    ...
    from harness._local_harmony_fallback import _LocalAuthor, _LocalContent, _LocalConversation, _LocalMessage, _LocalReasoningEffort, _LocalRole

    Author = _LocalAuthor
    SystemContent = _LocalContent
    ToolDescription = _LocalContent
    Role = _LocalRole
