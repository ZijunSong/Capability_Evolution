...
from trim.training.rl_opd_policy_version import PolicyVersionMismatch
from trim.training.rl_opd_types import UPDATE_OPD_ONLY_ZERO_RL, UPDATE_RL_ONLY, UPDATE_RL_OPD_JOINT
from trim.training.tinker_opd_datum import TinkerOPDDatum
from trim.training.tinker_rl_opd_trainer import hybrid_train_substep
...
def test_scape_rl_substep_uses_sampled_gap_fb():
    client = FakeTrainingClient()
    metrics = _run(
        training_client=client,
        rl_datums=[{"n_tokens": 4}],
