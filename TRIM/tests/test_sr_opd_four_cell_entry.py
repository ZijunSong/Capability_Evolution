...
from trim.training.four_cell_runtime import TEACHER_REGISTRY, build_manifest, cells_for_mode, validate_wiring
from trim.training.rl_opd_types import TRAINING_MODE_RL, TRAINING_MODE_RL_OPD, TRAINING_MODE_SCAPE_RL, TRAINING_MODE_SCAPE_SEED, TRAINING_MODE_PURE_OPD
...
def test_coerce_runtime_args_defaults_train_only_off():
    ...
    from trim.training.four_cell_runtime import coerce_runtime_args
