...
#
# Usage:
#   bash TRIM/scripts/run_bcplus_w_harness1_gpu8_eval.sh
#
# Split entry points (Qwen / gpt-oss only, one cell each):
#   run_bcplus_w_harness1_qwen_zero_gpu8_eval.sh
#   run_bcplus_w_harness1_qwen_all_gpu8_eval.sh
#   run_bcplus_w_harness1_gptoss_zero_gpu8_eval.sh
#   run_bcplus_w_harness1_gptoss_all_gpu8_eval.sh
#
# Optional env:
