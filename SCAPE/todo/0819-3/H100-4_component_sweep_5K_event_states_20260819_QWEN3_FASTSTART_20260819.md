# H100-4：Control Components + 10-Component Aggregation — Qwen3 Fast-Start OPD + 5K Formal Protocol
...
```text
/mnt/songzijun/models/Qwen3-30B-A3B-Instruct-2507
同一个 Qwen3 native chat adapter contract
...
```text
logical model id == Qwen3-30B-A3B-Instruct-2507
resolved revision/model config SHA
tokenizer SHA
Qwen3 native chat adapter SHA
query manifest SHA
